...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @C:/Users/lucas/me/pet-site/.codex/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
