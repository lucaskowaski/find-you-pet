...
Read and follow `C:/Users/lucas/me/pet-site/.codex/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
