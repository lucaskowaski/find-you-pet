...
- **Global scope**: `C:/Users/lucas/me/pet-site/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/lucas/me/pet-site/.codex/notes/`)
...
2. Glob `C:/Users/lucas/me/pet-site/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/lucas/me/pet-site/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/lucas/me/pet-site/.codex/notes/` — works in any directory
